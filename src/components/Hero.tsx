...
export default function Hero() {
  return (
    <section className="min-h-[calc(100vh-64px)] flex items-center px-6 py-16 gap-12 relative overflow-hidden" style={{ background: '#F7F4EF' }}>
      ...
      <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center gap-10 relative z-10">
        {/* Text — 45% width */}
        ...
        {/* Slideshow — 55% width, lebih besar */}
        <div className="hidden md:block" style={{ flex: '0 0 55%' }}>
          <HeroPhotoStack />
        </div>
      </div>
    </section>
